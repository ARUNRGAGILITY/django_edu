...
app_name = "app_transformation"
def transformation_home_page(request):
    #
    ...
    template_file = f"{app_name}/transformation_home.html"
...
def test_markdown(request):
    ...
    if os_info.find("Linux") != -1:
        prod_path = f"/home/DEVAGILEAGILITY/com_agiletia/django_edu/"
