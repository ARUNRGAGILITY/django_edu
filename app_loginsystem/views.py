from app_web.common.all_view_imports import *
from .forms import *
from .models import *

app_base_ref = "app_loginsystem"

class custom_password_change_view(PasswordChangeView):
    template_name = f"{app_base_ref}/user/password_change.html"
...
def login_page(request):
    ...
    context = {'page': page}
    template_url = f"{app_base_ref}/user/login.html"
...
def home(request):
    context = {'page': 'home'}
    template_url = f"{app_base_ref}/user/logged_in.html"
    return render(request, template_url, context)

def register_page(request):
    page = 'register'
    template_url = f"{app_base_ref}/user/register.html"
    if request.user.is_authenticated:
        return redirect('user_home')
